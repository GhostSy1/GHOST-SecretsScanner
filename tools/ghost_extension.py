...
VERSION = "3.0-PRO"
PROFILE = "Local secret-exposure detection and redaction engine"
RULES = [('SEC-TOKEN', 'api[_-]?key|access[_-]?token|bearer\\s+[A-Za-z0-9._~+/=-]+'), ('SEC-CRED', 'password\\s*[:=]|secret\\s*[:=]|private[_ -]?key'), ('SEC-CLOUD', 'AKIA[0-9A-Z]{16}|ghp_[A-Za-z0-9]{20,}|BEGIN [A-Z ]+PRIVATE KEY')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-SecretsScanner v3.0-PRO (Zero-Guessing Engine)
\"\"\"
    print(banner)
